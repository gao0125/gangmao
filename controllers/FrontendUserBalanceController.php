...
use Yii;
use backend\models\FrontendUserBalance;
use yii\web\Controller;
use yii\filters\VerbFilter;
use backend\models\search\FrontendUserBalanceSearch;
use yii\web\NotFoundHttpException;



class FrontendUserBalanceController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new FrontendUserBalanceSearch();
